...
from api.routes.messages import api_message# Blueprint de chat/mensajes
...
mail = Mail(app)
app.mail = mail  # Permitimos acceso global al objeto mail
...
# Setup Admin y comandos personalizados
setup_admin(app)
setup_commands(app)
...
app.register_blueprint(api_reset, url_prefix="/api")    # Password reset routes
app.register_blueprint(api_message, url_prefix="/api_message")  # Rutas chat/mensajes
...
# Servir frontend o sitemap según entorno
@app.route('/')
def sitemap():
